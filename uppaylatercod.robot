...
${shipkerry}                //*[@id="modal_change_carriers"]/div/div/div[3]/div/div/div/div[1]/div[1]/div[4]/button
...
${settingupsale}            //html/body/section/div[2]/div[4]/div[3]/div/div/div/div[7]/div[2]/div/ul/li
${openupsale}               //html/body/section/div[2]/div[4]/div[3]/section/div/div/div[1]/div[2]/div[2]/div[1]/div[1]/label[2]/div/div
${announcementconfirm}      //*[@id="announcement16"]/div[2]/button[1]
${vatconfirm}               //*[@id="announcement1"]/div[2]/button[1]
${announcementconfirm2}     //*[@id="announcement2"]/div[2]/button[1]
...
Click Shop
    ...
    sleep   5s
    ${c2} =   Get Element Count         ${announcementconfirm2}
    Run Keyword If   ${c2}>0            Click announcement2
    sleep   2s
    ${c} =   Get Element Count          ${announcementconfirm}
    Run Keyword If   ${c}>0             Click announcement
    sleep   2s
    ${v} =   Get Element Count          ${vatconfirm}
    Run Keyword If   ${v}>0             Click vat
    sleep   2s
...
Click announcement2
    Click element                       ${announcementconfirm2}
...
Open Upsale
    ...
    Press Keys                          xpath=//body        \ue00f
    Wait until element is visible       ${settingupsale}
    Click element                       ${settingupsale}
    sleep   2s
    Wait until element is visible       ${openupsale}
    Click element                       ${openupsale}
    sleep   1s
